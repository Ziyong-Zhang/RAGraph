...
EXTRACTOR_SYSTEM_PROMPT = (
    ...
    "Relationships do NOT need to be strictly familial or professional. If characters "
    "converse, travel together, or have observed emotional interactions (e.g., "
    "'Conversing', 'Observing', 'Fellow passengers'), those should also be extracted "
    "as relationships.\n\n"
    "STRICT ALIAS RULES:\n"
