...
EXTRACTOR_SYSTEM_PROMPT = (
    ...
    "4. Extract relationships between characters. The `nature` field defines the "
    "structural, social, or emotional status between characters (e.g., 'Colleagues', "
    "'Strangers', 'Secret Lovers', 'Suspicious of', 'Fellow Passengers').\n"
    "   - Rule 1 (State over Action): `nature` MUST describe the status between "
    "characters, NOT an ephemeral action or event.\n"
    "   - Rule 2 (Forbidden Verbs): NEVER use verbs ending in '-ing' (e.g., "
    "'conversing', 'observing', 'assisting') in the `nature` field.\n"
    "   - Rule 3 (Inference): Use interactions as evidence to deduce the true "
    "relationship. e.g. If A and B are having an 'intimate conversation', deduce 'Acquaintances'.\n"
    "   - Rule 4 (Conciseness): `nature` MUST be concise (maximum 2-4 words). "
    "Detailed context about interactions should go into character `description`.\n\n"
    "STRICT ALIAS RULES:\n"
